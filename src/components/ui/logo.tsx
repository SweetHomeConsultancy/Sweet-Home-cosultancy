...
export function Logo({ light = false, className }: LogoProps) {
  return (
    ...
    >
      {/* Emblem Icon */}
      <div className="relative shrink-0 flex items-center bg-[#EFEBE3] rounded">
        <Image
          ...
          className={cn(
            "h-10 sm:h-12 md:h-13 lg:h-14 w-auto object-contain transition-transform duration-300 group-hover:scale-105 p-1",
            light
      ...
      <div className="flex flex-col justify-center items-center leading-none tracking-normal">
        ...
        <div className="flex items-center justify-center gap-1 sm:gap-1.5 my-[2px] sm:my-[3px] w-full">
          ...
          <span
            className={cn(
              "font-heading font-bold text-[8.5px] sm:text-[8.5px] md:text-[9.5px] uppercase tracking-[0.2em] sm:tracking-[0.26em] transition-colors duration-300 leading-none whitespace-nowrap",
              light ? "text-brand-accent-light" : "text-brand-accent-deep"
            )}
          >
